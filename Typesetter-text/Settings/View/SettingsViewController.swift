...
class SettingsViewController: UIViewController {
    ...
    @IBAction func clickedContactUs(_ sender: UIButton) {
        if MFMailComposeViewController.canSendMail() {
            ...
            mailComposeVC.setToRecipients(["danyalkaryas@icloud.com"])
    ...
    @IBAction func clickedPrivacyPolicy(_ sender: UIButton) {
        ...
        privacyVC.url = URL(string: "https://docs.google.com/document/d/1Fu0cVdq4yrz_QbNAVaUtLv9q7qE81y5jsQAf_zGG21w/mobilebasic")
